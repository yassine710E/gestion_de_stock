...
export default function Show({ command, fournisseur, products }) {
        ...
        >
            ...
            <div className="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
                <div className="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                    <div className="p-8">
                        {/* fournisseur Information Card */}
                        <div className="bg-gray-50 rounded-lg p-6 mb-8">
                            <h3 className="text-lg font-semibold text-gray-800 mb-4">Informations fournisseur</h3>
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div className="flex items-center">
                                    <span className="text-gray-600 font-medium w-24">fournisseur:</span>
                                    <span className="text-gray-800">{fournisseur.nom} {fournisseur.nom_complet}</span>
                                </div>
                                <div className="flex items-center">
                                    <span className="text-gray-600 font-medium w-24">Email:</span>
                                    <span className="text-gray-800">{fournisseur.email}</span>
                                </div>
                                <div className="flex items-center">
                                    <span className="text-gray-600 font-medium w-24">Téléphone:</span>
                                    <span className="text-gray-800">{fournisseur.telephone}</span>
                                </div>
                                <div className="flex items-center">
                                    <span className="text-gray-600 font-medium w-24">Date Livraison:</span>
                                    <span className="text-gray-800">{command.date_livraison}</span>
                                </div>
                            </div>
                        </div>
